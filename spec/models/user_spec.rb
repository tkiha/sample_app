...
describe User do
  ...
  it { should respond_to(:password_confirmaion) }
  ...
  describe "when password is not present" do
    before do
      @user = User.new(name: "Example Useraaaa", email: "user@example.com", password: " ", password_confirmation: " ")
    end
    it { should_not be_valid }
  end
  ...
  describe "when password doesn't match confirmaion" do
    before do
      @user.password = "aaaaa"
      # @user.password_confirmaion = "mismatch"
    end
    it { should_not be_valid }
  end
